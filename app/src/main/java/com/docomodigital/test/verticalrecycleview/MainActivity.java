...
//LEVEL 3
stickers.add(new Sticker("montgolfiere", new ThumbRect((int) (648 *scale), (int) (0*scale), (int) (547*scale), (int) (793*scale)), Environment.getExternalStorageDirectory().getPath(), 400));
data.add(new MapLevel("grade2", R.drawable.map3_0,(int)(1080*scale),(int)(1159*scale), stickers));

stickers = new ArrayList<>();
data.add(new MapLevel("grade2", R.drawable.map3_1,(int)(1080*scale),(int)(1159*scale), stickers));
...
data.add(new MapLevel("grade2", R.drawable.map3_2,(int)(1080*scale),(int)(1159*scale), stickers));


stickers = new ArrayList<>();
stickers.add(new Sticker("hotel", new ThumbRect((int) (50*scale), (int) (240*scale), (int) (424*scale), (int) (426*scale)), Environment.getExternalStorageDirectory().getPath(), 400));
data.add(new MapLevel("grade2", R.drawable.map3_3,(int)(1080*scale),(int)(1159*scale), stickers));

stickers = new ArrayList<>();
stickers.add(new Sticker("bateau", new ThumbRect((int) (650*scale), (int) (650*scale), (int) (274*scale), (int) (314*scale)), Environment.getExternalStorageDirectory().getPath(), 40));
data.add(new MapLevel("grade2", R.drawable.map3_4,(int)(1080*scale),(int)(1159*scale), stickers));
